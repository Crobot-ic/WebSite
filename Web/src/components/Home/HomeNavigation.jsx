...
const HomeNavigation = () => {
    return (
        <section className="home-navigation">    
            <HomeNavChoice 
                titleNav="Nos projets" 
                buttonInfo="Découvez-les !" 
                goTo="/projects"
                transitionInit={-50}
            >
                <p className="home-nav-text">
                    L'association possède d'innombrables projets tous aussi intéressants les uns que les autres !
                </p>
            </HomeNavChoice>

            <HomeNavChoice 
                titleNav="Nos événements" 
                buttonInfo="Découvez-les !" 
                goTo="/events"
                transitionInit={50}
            >
